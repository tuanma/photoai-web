    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                var flagIcon = "images/flags/" + country.code + ".png";
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
                ...
                var flagIcon = "images/flags/" + def + ".png";
                var htmlFlag = `<span><img src="${flagIcon}" alt="">${name}</span>`;
                button.html(htmlFlag);
                button.show();
            });
            ...
            countryInput.eq(i).on('change', function () {
                ...
                flagIcon = "images/flags/" + def + ".png";
                htmlFlag = `<span><img src="${flagIcon}" alt="">${name}</span>`;
                button.html(htmlFlag);
                button.dropdown()
            });
        }else{
